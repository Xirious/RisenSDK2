...
public:    virtual GEBool                           ConvertStringToValue( bCObjectBase *, bCString const & ) const = 0;  // [0000].0024
public:    virtual GEBool                           ConvertValueToString( bCObjectBase const *, bCString & ) const = 0;  // [0000].0028
