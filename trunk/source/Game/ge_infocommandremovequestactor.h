...
public:
    gCInfoCommandRemoveQuestActor & operator = ( gCInfoCommandRemoveQuestActor const & );
public:
    gCInfoCommandRemoveQuestActor( gCInfoCommandRemoveQuestActor const & );
    gCInfoCommandRemoveQuestActor( void );
};
